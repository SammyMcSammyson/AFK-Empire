    ...
    <NavigationMenu.Root className="relative">
      ...
      {isOpen && (
        <NavigationMenu.List className="absolute top-12 right-0 w-40 bg-white rounded-lg shadow-lg flex flex-col p-4 space-y-2">
          <NavigationMenu.Item>
            <Link href="/" className="text-gray-800 font-semibold hover:bg-gray-100 px-3 py-2 rounded">
              Home
            </Link>
          </NavigationMenu.Item>

          <NavigationMenu.Item>
            <Link href="/profile" className="text-gray-800 font-semibold hover:bg-gray-100 px-3 py-2 rounded">
              Profile
            </Link>
          </NavigationMenu.Item>

          <NavigationMenu.Item>
            <Link href="/shop" className="text-gray-800 font-semibold hover:bg-gray-100 px-3 py-2 rounded">
              Shop
            </Link>
          </NavigationMenu.Item>
